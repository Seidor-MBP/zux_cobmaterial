		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cobertura Material",
									"targetURL": "#commbpzuxcobmaterial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commbpzuxcobmaterial-display": {
								"semanticObject": "commbpzuxcobmaterial",
								"action": "display",
								"description": "Cobertura Material",
								"title": "Cobertura Material",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mbp.zuxcobmaterial",
									"url": sap.ui.require.toUrl("com/mbp/zuxcobmaterial")
								}
							}
						}
					}
